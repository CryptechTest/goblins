...
if not goblins.db_fields["copper_follow"] then
    goblins.db_write("copper_follow", {
        "default:gold_lump", "default:blueberries", "default:apple",
        "default:torch"
    })
end
...
if not goblins.db_fields["copper_drops"] then
    goblins.db_write("copper_drops", {
        {name = "default:pick_diamond", chance = 1000, min = 0, max = 1},
        {name = "default:shovel_diamond", chance = 1000, min = 0, max = 1},
        {name = "default:axe_diamond", chance = 1000, min = 0, max = 1},
        {name = "default:pick_bronze", chance = 10, min = 0, max = 1},
        {name = "default:bronze_ingot", chance = 7, min = 0, max = 1},
        {name = "default:axe_bronze", chance = 5, min = 0, max = 1}
    })
end
...
if not goblins.db_fields["iron_drops"] then
    goblins.db_write("iron_drops", {
        ...
        {name = "default:shovel_diamond", chance = 1000, min = 0, max = 1},
        {name = "default:axe_diamond", chance = 1000, min = 0, max = 1},
        {name = "default:pick_steel", chance = 10, min = 0, max = 1},
        {name = "default:steel_ingot", chance = 7, min = 0, max = 1},
        {name = "default:axe_steel", chance = 5, min = 0, max = 1}
    })
end
...
if not goblins.db_fields["gold_drops"] then
    goblins.db_write("gold_drops", {
        ...
        {name = "default:shovel_diamond", chance = 1000, min = 0, max = 1},
        {name = "default:axe_diamond", chance = 1000, min = 0, max = 1},
        {name = "default:pick_gold", chance = 100, min = 0, max = 1},
        {name = "default:gold_lump", chance = 7, min = 0, max = 1},
        {name = "default:pick_bronze", chance = 5, min = 0, max = 1}
    })
end

if not goblins.db_fields["diamond_follow"] then
    goblins.db_write("diamond_follow", {
        "default:diamond", "default:blueberries", "default:apple",
        "default:torch"
    })
end
...
if not goblins.db_fields["diamond_drops"] then
    goblins.db_write("diamond_drops", {
        {name = "default:pick_mese", chance = 1000, min = 0, max = 1},
        {name = "default:shovel_mese", chance = 1000, min = 0, max = 1},
        {name = "default:axe_mese", chance = 1000, min = 0, max = 1},
        {name = "default:pick_diamond", chance = 100, min = 0, max = 1},
        {name = "default:diamond", chance = 7, min = 0, max = 1},
        {name = "default:pick_bronze", chance = 5, min = 0, max = 1}
    })
end
...
if not goblins.db_fields["hoarder_drops"] then
    goblins.db_write("hoarder_drops", {
        {name = "default:meselamp", chance = 1000, min = 0, max = 1},
        {name = "default:pick_mese", chance = 1000, min = 0, max = 1},
        {name = "default:shovel_mese", chance = 10, min = 0, max = 1},
        {name = "default:mese_crystal", chance = 7, min = 0, max = 1},
        {name = "default:pick_bronze", chance = 5, min = 0, max = 1}
    })
end
...
if not goblins.db_fields["gob_drops"] then
    goblins.db_write("gob_drops", {
        {name = "default:torch", chance = 4, min = 0, max = 10},
        {name = "default:flint", chance = 3, min = 0, max = 2},
        {name = "default:mossycobble", chance = 3, min = 0, max = 3},
        {
...
if not goblins.db_fields["template_drops"] then
    goblins.db_write("template_drops", {
        ...
        {name = "default:pick_mossycobble", chance = 10, min = 0, max = 1},
...
if not goblins.db_fields["template_follow"] then
    goblins.db_write("template_follow", {
        ...
        "default:blueberries", "default:torch", "default:cactus",
        "default:stick", "flowers:mushroom_brown", "flowers:mushroom_red"
    })
end
